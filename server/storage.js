...
var DatabaseStorage = /** @class */ (function () {
    ...
    DatabaseStorage.prototype.getNotesByUserId = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db.select().from(schema_1.notes).where((0, drizzle_orm_1.eq)(schema_1.notes.userId, userId))];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    DatabaseStorage.prototype.createNote = function (note) {
        return __awaiter(this, void 0, void 0, function () {
            var newNote;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    DatabaseStorage.prototype.updateNote = function (id, userId, noteUpdate) {
        return __awaiter(this, void 0, void 0, function () {
            var updatedNote;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.db
                            ...
                            .set(noteUpdate)
                            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.notes.id, id), (0, drizzle_orm_1.eq)(schema_1.notes.userId, userId)))
                            .returning()];
                    case 1:
                        updatedNote = (_a.sent())[0];
                        return [2 /*return*/, updatedNote || undefined];
                }
            });
        });
    };
    DatabaseStorage.prototype.deleteNote = function (id, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            var _a;
